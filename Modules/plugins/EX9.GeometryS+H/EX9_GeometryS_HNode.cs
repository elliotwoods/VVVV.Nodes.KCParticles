...
{
	#region PluginInfo
	[PluginInfo(Name = "S+H", Category = "EX9.Geometry", Help = "Basic template which creates a mesh", Tags = "")]
	#endregion PluginInfo
	public class EX9_GeometryS_HNode : DXMeshOutPluginBase, IPluginEvaluate
	{
		#region fields & pins
		...
		public EX9_GeometryS_HNode(IPluginHost host) : base(host)
		{
		}
